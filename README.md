...
ကီးဘုတ်မှာ စပေစ့်ဘားရှိတဲ့ အောက်ဆုံး key row ကို A row အဖြစ်မြင်ပါ။ အောက်ကနေ အထက်ကို A, B, C, D, E ဆိုပြီးတက်သွားပါမယ်။ Key row တခုချင်းစီမှာ ဘယ်ကနေ၊ ညာဘက်ကို special key (ဥပမာ Ctrl, Shift, CapsLock, Tab ...) တွေကို မစဉ်းစားပဲ 1, 2, 3, 4, 5 ... ဆိုပြီး နံပါတ်တခုချင်းစီတိုးပြီး ရေတွက်ပါတယ်။ Alphabetic key တွေကို A နဲ့စပါတယ်။ အခုလောက်ဆို မြင်လောက်ပါပြီ။ အဲဒါကြောင့် z key ကို AB01 လို့နာမည်ပေးထားပါတယ်။ ထိုနည်းလည်းကောင်း z key ကနေအပေါ်ကို တက်သွားမယ်ဆိုရင်၊ a key ကို AC01, q key ကို AD01 ဆိုပြီးခေါ်ပါတယ်။ q key ရှိတဲ့နေရာကနေ ဘယ်ဘက်ကို ရွှေ့ကြည်မယ်ဆိုရင်၊ w key က AD02၊ e key က AD03၊ r key က AD04 ဆိုပြီး အသီးသီး နာမည် သတ်မှတ်ထားပါတယ်။
