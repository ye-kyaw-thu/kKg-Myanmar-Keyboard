...
နံပါတ် ၄ အဆင့်ကို အထက်ပါ ဖော်ပြထားခဲ့တဲ့ နည်းအပြင်၊ Ubuntu OS ရဲ့ "System Setting" ကနေလည်းသွားလို့ရပါတယ်။ အဲဒီလိုသွားမယ်ဆိုရင်တော့၊ "System Setting" menu ကနေ "Text Entry" ကိုရွေးပါ ပြီးတော့ "+" button ကို နှိပ်ပြီး "Burmese" ကိုရွေးပါ။  
 ...
 ### Uninstall လုပ်နည်း (သို့) System ရဲ့ default mm ကီးဘုတ်လက်ကွက်သို့ ပြန်ပြောင်းခြင်း
 ...
 * Linux OS မှာ input device တစ်ခုကနေ application အထိ ဘယ်လို အဆင့်ဆင့် input handling လုပ်သလဲဆိုတာကို အလွယ်ရှင်းပြရရင်၊ အရင်ဆုံး hardware တစ်ခုဖြစ်တဲ့ ကီးဘုတ် ကနေ ကီးတစ်ခုကို နှိပ်လိုက်လို့ (သို့) လွှတ်လိုက်လို့ event signal ဝင်လာတဲ့အခါမှာ CPU က interrupt ဖြစ်ပြီး kernel က event signal နဲ့ ပတ်သက်ပြီးရှာဖွေပါတယ်။ အဲဒီနောက်၊ kernel က scancode အနေနဲ့ ဘယ်ကီးကို နှိပ်တယ်၊ လွှတ်လိုက်တယ် ဆိုတာကို သိရှိပါတယ်။ အဲဒီနောက် X11 (X Window server) က kernel ကနေ ရလာတဲ့ scancode ကို ကီးဘုတ်ရဲ့ device ဖိုင်နဲ့တိုက်စစ်ပြီး keycode အနေနဲ့ လက်ခံယူပါတယ်။ X11 ကနေမှ keysym+Modifiers အနေနဲ့ user သုံးတဲ့ application ဆီကိုပို့ပါတယ်။ ဒီနေရာမှာ keysym ဆိုတာက Key symbol စာလုံးရဲ့ အတိုကောက်ဖြစ်ပြီး၊ Modifiers ဆိုတာက Shift ကီး၊ Contrl ကီး၊ Alter ကီး စတဲ့ ကီးတွေကိုပါ တွဲနှိပ်လိုက်သလား ဆိုတဲ့ အချက်အလက်တွေပါ။ မြင်သာအောင် ပုံဆွဲပြရရင်တော့ အောက်ပါအတိုင်း ဖြစ်ပါလိမ့်မယ်။
