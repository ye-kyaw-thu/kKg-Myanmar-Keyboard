 ...
 * Linux OS မှာ input device (ဥပမာ ကီးဘုတ်) တစ်ခုကနေ application အထိ ဘယ်လို အဆင့်ဆင့် input handling လုပ်သလဲဆိုတာကို အလွယ်ရှင်းပြရရင်၊ အရင်ဆုံး hardware ကနေ scancode အနေနဲ့ kernel keyboard driver ဆီကိုပို့ပါတယ်။ kernel keyboard driver ကနေ keycode အနေနဲ့ X11 (X Window System) ဆီကိုပို့ပါတယ်။ X11 ကနေမှ keysym အနေနဲ့ userသုံးတဲ့ application ဆီကိုပို့ပါတယ်။  
